...
if(isset($_POST['Submit']))
{
  ...
  $uid=intval($_GET['uid']);
$query=mysqli_query($link,"update users set fname='$fname' ,lname='$lname' , contactno='$contact' where id='$uid'");
...
<html lang="en">
  ...
  <section id="container" >
      ...
      <?php $ret=mysqli_query($link,"select * from users where id='".$_GET['uid']."'");
